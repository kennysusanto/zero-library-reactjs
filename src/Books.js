    ...
    if (error) {
        ...
        if (view === 'list') {
            ...
            let tile =
                ...
                ;
            let innerContent = viewType === 'list' ? list : tile;
            content =
                <Col>
                    <Row>
                        <Col>
                    ...
                    <Row>
                        ...
                        <Col>
                            <ButtonGroup>
                                <Button variant={viewType === 'list' ? 'primary' : 'light'} onClick={() => setViewType('list')}><BsList></BsList> List</Button>
                                <Button variant={viewType === 'tile' ? 'primary' : 'light'} onClick={() => setViewType('tile')}><BsGrid3X2Gap></BsGrid3X2Gap> Tile</Button>
                            </ButtonGroup>
                        </Col>
                    </Row>
                    <Row>
